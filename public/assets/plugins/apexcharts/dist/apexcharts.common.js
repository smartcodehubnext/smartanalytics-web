      ...
      return {
        ...
        tooltip: {
          ...
          custom: function custom(_ref3) {
            ...
            return '<div className="apexcharts-tooltip-rangebar">' + '<div> <span className="series-name" style="color: ' + color + '">' + (w.config.series[seriesIndex].name ? w.config.series[seriesIndex].name : '') + '</span></div>' + '<div> <span className="category">' + ylabel + ': </span> <span className="value start-value">' + startVal + '</span> <span className="separator">-</span> <span className="value end-value">' + endVal + '</span></div>' + '</div>';
          }
        },
        xaxis: {
          tooltip: {
